  ...
  return (
    <div className="relative w-full h-48 sm:h-64 md:h-80 rounded-lg overflow-hidden group">
      ...
      <Button
        ...
        className="absolute top-2 right-2 sm:top-3 sm:right-3 bg-white/80 hover:bg-white text-foreground rounded-full shadow-lg h-8 w-8 sm:h-9 sm:w-9 transition-all hover:scale-110 active:scale-95 opacity-0 group-hover:opacity-100 z-10"
      >
